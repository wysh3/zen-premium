...
var ucjsMouseGestures = {
  ...
  commands :
      ...
      [
        ...
        ['', 'Pop up the tab history', function(){ ucjsMouseGestures_helper.sessionHistoryPopup(); } ],
        ...
        ['RLR', '>> Fast forward', function(){ ucjsNavigation?.fastNavigationBackForward(1); } ],
        ['LRL', '<< Rewind', function(){ ucjsNavigation?.fastNavigationBackForward(-1); } ],

        ['RULD', 'Move to the next higher level', function(){ ucjsMouseGestures_helper.goUpperLevel(); } ],
        ['ULDR', 'Increase the number and move', function(){ ucjsMouseGestures_helper.goNumericURL(+1); } ],
        ['DLUR', 'Decrease the number and move', function(){ ucjsMouseGestures_helper.goNumericURL(-1); } ],
        ['RL', 'Move to links such as [Next]', function(){ ucjsNavigation?.advancedNavigateLink(1); } ],
        ['LR', 'Move to links such as [Back]', function(){ ucjsNavigation?.advancedNavigateLink(-1); } ],
        ...
        ['', 'Stop Loading', function(){ document.getElementById("Browser:Stop").doCommand(); } ],

        ['', 'Open link in a specified container tab', function(){ ucjsMouseGestures_helper.openLinkInContainerTab(); } ],

        ['', 'Open all selected text links in tabs (If no links, search with the default search engine)', function(){ ucjsMouseGestures_helper.openURLsInSelection(); } ],
        ['*RDL', 'Open all selected links in tabs', function(){ ucjsMouseGestures_helper.openSelectedLinksInTabs(); } ],
        ['*RUL', 'Open all hovered links in tabs', function(){ ucjsMouseGestures_helper.openHoverLinksInTabs(); } ],
        ['', 'Open link in a new tab', function(){ ucjsMouseGestures_helper.openURLs([ucjsMouseGestures._linkURL]); } ],

        ['', 'Save selected links', function(){ ucjsMouseGestures_helper.saveSelectedLinks(); } ],
        ['', 'Save hover links', function(){ ucjsMouseGestures_helper.saveHoverLinks(); } ],

        ['', 'Copy text', function(){ ucjsMouseGestures_helper.copyText(ucjsMouseGestures._selectedTXT); } ],
        ...
        ['UL', 'Previous tab', function(){ gBrowser.tabContainer.advanceSelectedTab(-1, true); } ],
        ['UR', 'Next tab', function(){ gBrowser.tabContainer.advanceSelectedTab(+1, true); } ],
        ['ULR', 'Previously selected tab', function(){ ucjsNavigation_tabFocusManager?.advancedFocusTab(-1); } ],
        ['URL', 'Go back to the previously selected tab', function(){ ucjsNavigation_tabFocusManager?.advancedFocusTab(1); } ],

        ['', 'Open a new tab', function(){ document.getElementById("cmd_newNavigatorTab").doCommand(); } ],
        ['', 'Open a new container tab', function(){ ucjsMouseGestures_helper.openLinkInContainerTab("about:blank", false, false); } ],
        ['', 'Toggle pin tab',
        ...
        ['', 'Close tab (except pinned tabs)', function(){ if (!gBrowser.selectedTab.pinned) { document.getElementById("cmd_close").doCommand(); } } ],
        ...
        ['', 'Close all tabs', function(){ var browser = gBrowser; var ctab = browser.addTrustedTab(BROWSER_NEW_TAB_URL, {skipAnimation: true,}); browser.removeAllTabsBut(ctab); } ],
        ['', 'Close window', function(){ document.getElementById("cmd_closeWindow").doCommand(); } ],

        ['', 'Minimize', function(){ window.minimize(); } ],
        ['', 'Maximize/Restore size', function(){ window.windowState == 1 ? window.restore() : window.maximize(); } ],
        ['LDRU', 'Fullscreen', function(){ document.getElementById("View:FullScreen").doCommand(); } ],
        ...
        ['L<R', 'Reset zoom', function(){ ucjsMouseGestures_helper.zoomReset(); } ],
        ...
        ['DRD', 'Search selected text (search engine popup)', function(){ ucjsMouseGestures_helper.webSearchPopup(ucjsMouseGestures._selectedTXT || ucjsMouseGestures._linkTXT); } ],
        ...
        ['', 'Add selected text to search bar',
          function(){ 
        ...
        ['', 'Clear search bar (Web search box)',
          function(){
        ...
        ['', 'Bookmark sidebar', function(){ SidebarController.toggle("viewBookmarksSidebar"); } ],
        ['', 'History sidebar', function(){ SidebarController.toggle("viewHistorySidebar"); } ],

        ['', 'Clear recent history', function(){ setTimeout(function(){ document.getElementById("Tools:Sanitize").doCommand(); }, 0); } ],
        ['', 'Browser console', function(){ ucjsMouseGestures_helper.openBrowserConsole(); } ],
        ['', 'Add-on Manager', function(){ openTrustedLinkIn("about:addons", "tab", {inBackground: false, relatedToCurrent: true}); } ],
        ['', 'Support', function(){ openTrustedLinkIn("about:support", "tab", {inBackground: false, relatedToCurrent: true}); } ],
        ['', 'Preferences (options）', function(){ openTrustedLinkIn("about:preferences", "tab", {inBackground: false, relatedToCurrent: true}); } ],
        ['', 'Toggle weAutopagerize',
          function(){
            ucjsMouseGestures_helper.dispatchEvent(
                            { target: "document", type: "AutoPagerizeToggleRequest" } );
          } ],
        ['', 'Toggle weAutopagerize Method 2',
          function(){
